...
/**
 * This class implements the DateTime structure as adescribed in <a
...
public class DateTime implements IExpressionElement {
	...
	public boolean equals(Object o) {
		if (o instanceof DateTime) {
			...
			return (dt.getDay().equals(getDay())
					&& dt.getHour().equals(getHour())
					&& dt.getMillisecond().equals(getMillisecond())
					&& dt.getMinute().equals(getMinute())
					&& dt.getMonth().equals(getMonth())
					&& dt.getSecond().equals(getSecond())
					&& (dt.getTypeDesignator() == getTypeDesignator()) && ((dt
					.isSigned() && dt.getSign() == getSign()) || !dt.isSigned()));
		}
		return false;
	}
	 ...
	 * 
	 * @param encodedStr
	 *            the string to be set to the dateTimeBuffer.
	 */
	...
	/**
	 * Setter of millisecond. Defaults to 0 if the parameter < 0 or parameter >
	 * 999
	 * 
	 * @param millisecond
	...
	/**
	 * Setter of year. Defaults to 1000 if the parameter < 1000 or parameter >
	 * 9999
	 * 
	 * @param year
	 */
