    ...
    public int[] kos() {
    	...
    	if (kontrol == -1) {
        	...
        	if (kontrol == 0) {//kirma
            	...
            	System.out.println("konum " + kiranKonum);
            	System.out.println("zarID " + kiranZarID);
            	System.out.println("kiran zar " + kiranZar);
        	}
        	...
        	if (kontrol == 0) {
            	...
            	if (kontrol != 2) {
                	...
                	int hamleTamam = 0;
                	for (int i = 24; i > 5; i--) {//kapi ikinci oncelik
            			if (benim_pullar[i] > 0) {
            				for (int j = i-1; j < i-6 && j > 5; j++) {
