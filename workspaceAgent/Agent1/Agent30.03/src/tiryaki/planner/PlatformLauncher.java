...
public class PlatformLauncher {
	...
	public static void main(String[] args) {
		...
		Agent agent = new Agent(aid, "rmi://192.168.2.234/Agent");
	...
	public void rmic(String rmic) {
		try {
			Runtime.getRuntime().exec(
					rmic + " " + AgentRMIImpl01.class.getName());
		} catch (IOException e) {
	...
	public void startAMS() {
		...
		// // Start AMS
		// AgentManagementSystem ams = new AgentManagementSystem(amsInfo,
		// amsAddr, new AMSOntologyFacade());
	}
