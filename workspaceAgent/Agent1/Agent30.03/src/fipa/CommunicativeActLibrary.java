...
/**
 * This class represents the ACL communicative acts as described in <a
 * href="http://www.fipa.org/specs/fipa00037/">FIPA Communicative Act Library
 * Specification</a>
 * 
...
public class CommunicativeActLibrary {
	 ...
	 * longer has the intention that the second agent perform some action
	 */
	 ...
	 * the receiver is known to believe, believe it likely that, the proposition
	 * is true
	 */
	...
	/**
	 * The sender of the act (for example, <I>i</I>) informs the receiver (for
	 * example, <I>j</I>) that it perceived that <I>j</I> performed some action,
	 * but that <I>i</I> did not understand what <I>j</I> just did. A particular
	 * common case is that <I>i</I> tells <I>j</I> that <I>i</I> did not
	 * understand the message that <I>j</I> has just sent to <I>i</I>.
	 */
	...
	/**
	 * The sender requests the receiver to perform some action. One important
