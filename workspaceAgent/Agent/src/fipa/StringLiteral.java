...
/**
 * This class implements the StringLiteral structure as described in <a
...
public class StringLiteral extends AbstractStringElement {
	 ...
	 * after this object is given to an IStringLiteralEncoder instance
	 * 
	 ...
	 * encoded StringLiteral. To decode this object using an
	 * IStringLiteralEncoder instance, this method must be invoked first.
	 * 
	 * @param encodedStr
	 *            encoded string of the StringLiteral
	 */
