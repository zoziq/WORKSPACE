...
/**
 * Outcome ve Provision'lar arasindaki baglantiyi saglar.
 * 
 */
public final class ProvisionOutcomeLink extends Link {
	...
	/*
	 * public synchronized Object getOutcomeResult(){ if (this.senderOutcome ==
	 * null) { return null; } return
	 * this.senderOutcome.getResult(this.senderOutcomeName); }
	 */
