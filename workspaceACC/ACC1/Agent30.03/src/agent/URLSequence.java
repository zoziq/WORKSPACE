...
/**
 * This class implements the URLSequence structure as described in 
...
public class URLSequence implements Serializable {
	...
	/**
	 * Removes all of _urls from this class. The class will be empty 
	 ...
	 * @param index index of URL to return.
	 ...
	 * to an IURLSequenceEncoder instance
	 ...
	 * @param i index of the url to be removed
	 ...
	 * @param o url to be removed from this class, if present
	 ...
	 * is used to decode an encoded URLSequence. To decode 
	 * this object using an IURLSequenceEncoder instance, this
	 * method must be invoked first.
	 * @param encodedStr encoded string of the URLSequence
	 */
