...
/**
 * This class implements the AgentIdentifier structure as described in 
...
public class AgentIdentifier implements Serializable {
	...
	} // TODO dont create instances in the constructor, use factory methods instead	

	/* public auxiliary methods */
	// TODO check null fields in equals
	// Two agents with the same _name are equal
	...
	public boolean equals(Object o) {
		if (o instanceof AgentIdentifier) {
			...
			return (
				(aid.getName().equals(getName()))
					&& (aid.getAddresses().equals(getAddresses()))
					&& (aid.getResolvers().equals(getResolvers()))
					);
		} else {
			return false;
		}
	...
	/**
	 * Returns the encoded string of the AgentIdentifier.
	 * This method must be invoked after this object is given
	 * to an IAgentIdentifierEncoder instance
	...
	/**
	 * Sets the encoded string of the AgentIdentifier. This method
	 * is used to decode an encoded AgentIdentifier. To decode 
	 * this object using an IAgentIdentifierEncoder instance, this
	 * method must be invoked first.
	 * @param encodedStr encoded string of the AgentIdentifier
	 */
	 ...
	 * @param _name the _name of the agent
	 */
	 ...
	 * @param _resolvers the _resolvers of the agent
	 */
