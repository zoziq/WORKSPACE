...
/**
 * This class implements the Word structure as described in
...
public class Word  implements Serializable {
	 ...
	 * is used to decode an encoded Word. To decode 
	 * this object using an IWordEncoder instance, this
	 * method must be invoked first.
	 * @param encodedStr encoded string of the Word
	 */
