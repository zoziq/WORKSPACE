...
/**
 * This class is a container for other expression types. It holds expressions in an ArrayList structure.
 * An expression might contain one or more Number, DateTime, StringLiteral, 
 * ByteLengthEncodedString, Word or Expressions. 
 * Expression structure is defined in 
...
public class Expression implements IExpressionElement {
	...
	/**
	 * One parameter constructor. You may give expressions 
	 * while creating this expression using this constructor, or,
	 * instead, you may use default constructor and add expressions
	 * using {@link #addExpression(IExpressionElement) addExpression()} 
	 * or {@link #addExpressionList(ArrayList) addExpressionList()}
	 ...
	 * @param expElementList the list to be added.
	 * @see #addExpression(IExpressionElement)
	 */
	...
	/**
	 * Returns the ExpressionElement at the specified position in this Expression.
	 * @param index index of ExpressionElement to return.
	 * @return the ExpressionElement at the specified position in this Expression.
	 */
	 ...
	 * to an IExpressionEncoder instance
	 ...
	 * is used to decode an encoded Expression. To decode 
	 * this object using an IExpressionEncoder instance, this
	 * method must be invoked first.
	 * @param encodedStr encoded string of the Expression
	 */
