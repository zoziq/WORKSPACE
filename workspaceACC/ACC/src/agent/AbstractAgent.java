...
public abstract class AbstractAgent {
	...
	/**
	 * Logs a message. For now it only prompts the messages,
	 * future purpose is to save these messages in a file.
	...
	// identifier of this agent. it contains full name(agent@platform), addresses and resolvers.
